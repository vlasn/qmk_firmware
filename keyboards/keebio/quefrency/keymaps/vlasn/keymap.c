...
#define UPSHIFT MT(MOD_LSFT, KC_UP)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                          KC_N,    KC_M,     KC_COMM,  KC_DOT,  KC_SLSH, UPSHIFT, MO(_MOD), 
  ...
  [_MOD] = LAYOUT(
    ...
    RESET, KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,                                  _______, _______, _______, _______, TRKPREV, VOLDOWN, TRKNEXT
  )
};
